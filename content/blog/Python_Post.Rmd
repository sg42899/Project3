...
![](/blog/Python_Post_files/python.png)


## Python

I used regex in python to extract certain key words from sentences.

In this example, I extracted numbers from a string. 
...
I extracted IP addresses from the string. 
...
I extracted web addresses from the string. 
...
re.findall(r"(ftp:..ftp*..\w\w.FreeBSD.org.pub.FreeBSD.)",string3)
```

I counted the number of times a word appears in the paragraph from Moby Dick.
